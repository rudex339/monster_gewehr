	...
	world->each<Button_Component>([&](
		...
		ComponentHandle<Button_Component> button
...

			{
				...
				button->m_textFormat.Get()->SetParagraphAlignment(button->m_paragraph_alignment);	// �ؽ�Ʈ�� ������ ����� ��ġ
				button->m_textFormat.Get()->SetTextAlignment(button->m_text_alignment);			// �ؽ�Ʈ�� �¿��� ����� ��ġ
			...
			if (button->cursor_on && clicked && button->activate) {
				...
				Clicked(); // ��ư�� ������ ���� clicked�� false�� ����(���� ���콺�� �������߸� false�� �ٲ�� ������ ����� ���� �ذ��)
			}
		}
	);
