...
public:
	...
	CLoadedModelInfo* Get_ModelInfo(string name) { return m_ModelList[name].get(); }
...
public:
	...
	GameObjectModel							**m_ppGameObjects = NULL;

	int									m_nHierarchicalGameObjects = 0;
	GameObjectModel							**m_ppHierarchicalGameObjects = NULL;
