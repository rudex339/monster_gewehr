...
CShader* CMaterial::m_pEmitterShader = NULL;
...
void CMaterial::PrepareShaders(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	...
	m_pEmitterShader = new EmitterShader();
	m_pEmitterShader->CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature);
	m_pEmitterShader->CreateShaderVariables(pd3dDevice, pd3dCommandList);
}
...
void CMaterial::LoadTextureFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, UINT nType, UINT nRootParameter, _TCHAR* pwstrTextureName, CTexture** ppTexture, GameObjectModel* pParent, FILE* pInFile, CShader* pShader, int TileX, int TileY)
{
	...
	if (strcmp(pstrTextureName, "null"))
	{
		...
		if (!bDuplicated)
		{
			*ppTexture = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
			...
			ObjectManager::CreateShaderResourceViews(pd3dDevice, *ppTexture, 0, nRootParameter);
		}
		else
		{
			if (pParent)
			{
				...
				GameObjectModel* pRootGameObject = pParent;
...
GameObjectModel::GameObjectModel(int nMaterials) : GameObjectModel()
{
...
void GameObjectModel::SetChild(GameObjectModel* pChild, bool bReferenceUpdate)
{
	if (pChild)
	{
...
void GameObjectModel::SetMesh(CMesh* pMesh)
{
	if (m_pMesh) m_pMesh->Release();
	m_pMesh = pMesh;
...
void GameObjectModel::SetShader(CShader* pShader)
{
	m_nMaterials = 1;
	m_ppMaterials = new CMaterial * [m_nMaterials];
...
void GameObjectModel::SetShader(int nMaterial, CShader* pShader)
{
	if (m_ppMaterials[nMaterial]) m_ppMaterials[nMaterial]->SetShader(pShader);
}

void GameObjectModel::SetMaterial(int nMaterial, CMaterial* pMaterial)
{
...
CSkinnedMesh* GameObjectModel::FindSkinnedMesh(char* pstrSkinnedMeshName)
{
...
void GameObjectModel::FindAndSetSkinnedMesh(CSkinnedMesh** ppSkinnedMeshes, int* pnSkinnedMesh)
{
...
void GameObjectModel::UpdateTransform(XMFLOAT4X4* pxmf4x4Parent)
{
...
void GameObjectModel::SetTrackAnimationSet(int nAnimationTrack, int nAnimationSet)
{
	if (m_pSkinnedAnimationController) m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimationTrack, nAnimationSet);
}

void GameObjectModel::SetTrackAnimationPosition(int nAnimationTrack, float fPosition)
{
	if (m_pSkinnedAnimationController) m_pSkinnedAnimationController->SetTrackPosition(nAnimationTrack, fPosition);
}

void GameObjectModel::Animate(float fTimeElapsed)
{
	OnPrepareRender();
...
void GameObjectModel::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	if (m_pSkinnedAnimationController) m_pSkinnedAnimationController->UpdateShaderVariables();
...
void GameObjectModel::UpdateShaderVariable(ID3D12GraphicsCommandList* pd3dCommandList, XMFLOAT4X4* pxmf4x4World)
{
...
void GameObjectModel::UpdateShaderVariable(ID3D12GraphicsCommandList* pd3dCommandList, CMaterial* pMaterial)
{
}
...
void GameObjectModel::SetPosition(float x, float y, float z)
{
...
void GameObjectModel::SetPosition(XMFLOAT3 xmf3Position)
{
	SetPosition(xmf3Position.x, xmf3Position.y, xmf3Position.z);
}

void GameObjectModel::Move(XMFLOAT3 xmf3Offset)
{
...
void GameObjectModel::SetScale(float x, float y, float z)
{
...
XMFLOAT3 GameObjectModel::GetToParentPosition()
{
	return(XMFLOAT3(m_xmf4x4ToParent._41, m_xmf4x4ToParent._42, m_xmf4x4ToParent._43));
}

XMFLOAT3 GameObjectModel::GetLook()
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._31, m_xmf4x4World._32, m_xmf4x4World._33)));
}

XMFLOAT3 GameObjectModel::GetUp()
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._21, m_xmf4x4World._22, m_xmf4x4World._23)));
}

XMFLOAT3 GameObjectModel::GetRight()
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._11, m_xmf4x4World._12, m_xmf4x4World._13)));
}

void GameObjectModel::MoveStrafe(float fDistance)
{
	XMFLOAT3 xmf3Position = GetPosition();
	XMFLOAT3 xmf3Right = GetRight();
	xmf3Position = Vector3::Add(xmf3Position, xmf3Right, fDistance);
	GameObjectModel::SetPosition(xmf3Position);
}

void GameObjectModel::MoveUp(float fDistance)
{
	XMFLOAT3 xmf3Position = GetPosition();
...
void GameObjectModel::MoveForward(float fDistance)
{
	XMFLOAT3 xmf3Position = GetPosition();
...
void GameObjectModel::Rotate(float fPitch, float fYaw, float fRoll)
{
...
void GameObjectModel::Rotate(XMFLOAT3* pxmf3Axis, float fAngle)
{
...
void GameObjectModel::Rotate(XMFLOAT4* pxmf4Quaternion)
{
...
void GameObjectModel::LoadMaterialsFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, GameObjectModel* pParent, FILE* pInFile, CShader* pShader,int TileX, int TileY)
{
	char pstrToken[64] = { '\0' };
	int nMaterial = 0;
	UINT nReads = 0;
	...
	for (; ; )
	{
		...
		{
			pMaterial->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_ALBEDO_MAP, 3, pMaterial->m_ppstrTextureNames[0], &(pMaterial->m_ppTextures[0]), pParent, pInFile, pShader,TileX,TileY);
		}
		else if (!strcmp(pstrToken, "<SpecularMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_SPECULAR_MAP, 4, pMaterial->m_ppstrTextureNames[1], &(pMaterial->m_ppTextures[1]), pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<NormalMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_NORMAL_MAP, 5, pMaterial->m_ppstrTextureNames[2], &(pMaterial->m_ppTextures[2]), pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<MetallicMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_METALLIC_MAP, 6, pMaterial->m_ppstrTextureNames[3], &(pMaterial->m_ppTextures[3]), pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<EmissionMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_EMISSION_MAP, 7, pMaterial->m_ppstrTextureNames[4], &(pMaterial->m_ppTextures[4]), pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<DetailAlbedoMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_DETAIL_ALBEDO_MAP, 8, pMaterial->m_ppstrTextureNames[5], &(pMaterial->m_ppTextures[5]), pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<DetailNormalMap>:"))
		{
			m_ppMaterials[nMaterial]->LoadTextureFromFile(pd3dDevice, pd3dCommandList, MATERIAL_DETAIL_NORMAL_MAP, 9, pMaterial->m_ppstrTextureNames[6], &(pMaterial->m_ppTextures[6]), pParent, pInFile, pShader, TileX, TileY);
		}
...
GameObjectModel* GameObjectModel::LoadFrameHierarchyFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, GameObjectModel* pParent, FILE* pInFile, CShader* pShader, int* pnSkinnedMeshes, int TileX, int TileY )
{
	char pstrToken[64] = { '\0' };
	UINT nReads = 0;
	...
	for (; ; )
	{
		...
		else if (!strcmp(pstrToken, "<SkinningInfo>:"))
		{
			...
			if (!strcmp(pstrToken, "<Mesh>:")) pSkinnedMesh->LoadMeshFromFile(pd3dDevice, pd3dCommandList, pInFile, TileX, TileY);

			pGameObject->SetMesh(pSkinnedMesh);
		}
		else if (!strcmp(pstrToken, "<Materials>:"))
		{
			pGameObject->LoadMaterialsFromFile(pd3dDevice, pd3dCommandList, pParent, pInFile, pShader, TileX, TileY);
		}
		else if (!strcmp(pstrToken, "<Children>:"))
		{
			int nChilds = ::ReadIntegerFromFile(pInFile);//차일드 갯수 그러니까 서브 매쉬 갯수라고 생각해도 될듯
			if (nChilds > 0)
			{
				for (int i = 0; i < nChilds; i++)
				{
					GameObjectModel* pChild = GameObjectModel::LoadFrameHierarchyFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, pGameObject, pInFile, pShader, pnSkinnedMeshes, TileX, TileY);
...
void GameObjectModel::PrintFrameInfo(GameObjectModel* pGameObject, GameObjectModel* pParent)
{
	TCHAR pstrDebug[256] = { 0 };
	...
	if (pGameObject->m_pSibling) GameObjectModel::PrintFrameInfo(pGameObject->m_pSibling, pParent);
	if (pGameObject->m_pChild) GameObjectModel::PrintFrameInfo(pGameObject->m_pChild, pGameObject);
}

void GameObjectModel::LoadAnimationFromFile(FILE* pInFile, CLoadedModelInfo* pLoadedModel)
{
	char pstrToken[64] = { '\0' };
	UINT nReads = 0;
	...
	for (; ; )
	{
		...
		else if (!strcmp(pstrToken, "<FrameNames>:"))
		{
			...
			pLoadedModel->m_pAnimationSets->m_ppBoneFrameCaches = new GameObjectModel * [pLoadedModel->m_pAnimationSets->m_nBoneFrames];
...
CLoadedModelInfo* GameObjectModel::LoadGeometryAndAnimationFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, char* pstrFileName, CShader* pShader, int TileX, int TileY)
{
	FILE* pInFile = NULL;
	...
	for (; ; )
	{
		if (::ReadStringFromFile(pInFile, pstrToken))
		{
			...
			{
				pLoadedModel->m_pModelRootObject = GameObjectModel::LoadFrameHierarchyFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, NULL, pInFile, pShader, &pLoadedModel->m_nSkinnedMeshes, TileX, TileY);
				::ReadStringFromFile(pInFile, pstrToken); //"</Hierarchy>"
			}
			else if (!strcmp(pstrToken, "<Animation>:"))
			{
				GameObjectModel::LoadAnimationFromFile(pInFile, pLoadedModel);
...
CLoadedModelInfo* GameObjectModel::LoadGeometryFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, char* pstrFileName, CShader* pShader, int TileX, int TileY)
{
	FILE* pInFile = NULL;
	::fopen_s(&pInFile, pstrFileName, "rb");
	::rewind(pInFile);
...
CHeightMapTerrain::CHeightMapTerrain(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, LPCTSTR pFileName, int nWidth, int nLength, XMFLOAT3 xmf3Scale, XMFLOAT4 xmf4Color) : GameObjectModel(1)
{
	...
	pTerrainBaseTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Terrain/Detail_Texture_Ground.dds", RESOURCE_TEXTURE2D, 0);

	CTexture* pTerrainDetailTexture = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	pTerrainDetailTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Terrain/Detail_Texture_Ground.dds", RESOURCE_TEXTURE2D, 0);

	CTerrainShader* pTerrainShader = new CTerrainShader();
	pTerrainShader->CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature);
	pTerrainShader->CreateShaderVariables(pd3dDevice, pd3dCommandList);

	ObjectManager::CreateShaderResourceViews(pd3dDevice, pTerrainBaseTexture, 0, 13);
	ObjectManager::CreateShaderResourceViews(pd3dDevice, pTerrainDetailTexture, 0, 14);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
CSkyBox::CSkyBox(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature) : GameObjectModel(1)
{
...
void CSkyBox::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	...
	SetPosition(xmf3CameraPos.x, xmf3CameraPos.y+8.f, xmf3CameraPos.z);
...
void MultiSpriteObject3::Animate(float fTimeElapsed)
{
	if (m_ppMaterials[0] && m_ppMaterials[0]->m_ppTextures[0])
	{
		//((TextureRectMesh*)m_pMesh)->changeRowCol(0,0,8,8);
...
MultiSpriteObject3::MultiSpriteObject3(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, float x, float y, float z) : GameObjectModel(1)
{
	...
	CTexture* Texture = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	Texture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"image/blood.dds", RESOURCE_TEXTURE2D, 0);
...
void MultiSpriteObject3::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	SetLookAt(pCamera->GetPosition(), XMFLOAT3(0.0f, 1.0f, 0.0f));
	GameObjectModel::Render(pd3dCommandList, pCamera);
}
