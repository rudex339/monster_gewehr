...
public:
	...
	void LoadTextureFromFile(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, UINT nType, UINT nRootParameter, _TCHAR *pwstrTextureName, CTexture **ppTexture, GameObjectModel *pParent, FILE *pInFile, CShader *pShader);
...
public:
	...
	void LoadMaterialsFromFile(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, GameObjectModel *pParent, FILE *pInFile, CShader *pShader);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CSuperCobraObject : public GameObjectModel
{
public:
...
private:
	GameObjectModel					*m_pMainRotorFrame = NULL;
	GameObjectModel					*m_pTailRotorFrame = NULL;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CGunshipObject : public GameObjectModel
{
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CMi24Object : public GameObjectModel
{
public:
...
class CAngrybotObject : public GameObjectModel
{
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CMonsterObject : public GameObjectModel
{
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CHumanoidObject : public GameObjectModel
{
public:
...
class CEthanObject : public GameObjectModel
{
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CLionObject : public GameObjectModel
{
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CZebraObject : public GameObjectModel
{
public:
...
class CEagleObject : public GameObjectModel
{
public:
